# Prueba final
Realizar una predicción sobre la variable 'D.1 Escala de felicidad personal (0-10)'. Puede realizarse una regresión o plantearlo como un problema de clasificación. 
El modelo se evaluará sobre un conjunto de test no proporcionado, y ganará aquel con mejor métrica RMSE
