# -*- coding: utf-8 -*-
"""
Created on Tue May 10 20:00:37 2022
...
st.write("""
         # Aplicación de Predicción de Churn
         
         La fuga de clientes se define como la pérdida de los mismos después de un
         periodo de tiempo. Las empresas están interesadas en etiquetar a clientes
         que son propensos a abandonar la compañía, para ofrecerles ofertas 
         especiales y promociones, de manera que permanezcan en la compañía.
         
         Esta aplicación predice la probabilidad de fuga de clientes utilizando
         los datos de Telco Customer.
         """)
...
# Lee el modelo de clasificación
